...
#     `app.vault`, `activeDocument`, `activeWindow` etc. are in scope.
...
#     to nothing at runtime in this context. Use the plugin instance
#     (`app.plugins.plugins["mermaid-exporter"]`) for everything you need.
